...
export const Work = [
  {
    id: 1,
    name: "visualverse Social platform",
    description:
      "It is build on top of the vanila JS, with html5 and css , interative animations effects",
    tags: ["JAVASCRIPT", "DOM API", "HTML", "CSS"],

    demo: "https://visualverse01.netlify.app/",
    github: "https://github.com/prem-24/VisualVerse",
  },
  {
    id: 2,
